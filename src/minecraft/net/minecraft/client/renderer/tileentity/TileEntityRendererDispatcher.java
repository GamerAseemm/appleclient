...
public class TileEntityRendererDispatcher
{
    ...
    private CullHelper.CullFunction<TileEntity> cullFunction = blockEntity -> !Minecraft.getMinecraft().theWorld.isVisible(blockEntity) && !(blockEntity instanceof TileEntityBeacon);
