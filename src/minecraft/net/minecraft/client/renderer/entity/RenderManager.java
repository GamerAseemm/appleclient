...
public class RenderManager
{
    ...
    {
        boolean needsToRender = !CullHelper.isCulled(CullHelper.CullType.ENTITY, this.cullFunction.apply(entity)) || Minecraft.getMinecraft().gameSettings.thirdPersonView != 0;
